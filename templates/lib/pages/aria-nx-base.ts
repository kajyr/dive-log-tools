 ...
 */
function draw(doc: Doc, dive: Partial<Dive>) {
  page(doc, MARGINS, (doc, x, y, contentWidth, h) => {
    doc.lineWidth(0.8);

    const [nextX, nextY] = header(doc, 'SCHEDA ARIA - NITROX BASE', x, y, contentWidth, 30);
