const { FONT_SIZE_MINI_HEADERS, FONT_SIZE_FIELDS, MINI_HEADERS_HEIGHT, PANELS_SPACING } =
  require('../constants/ara-didattica').default;
...
const component = (doc, x, y, w, h, dive) =>
  panel(doc, x, y, w, h, PANELS_SPACING, (doc, x, y, w, h) => {
    ...
    const [first, second] = columns(doc, [75, 25], x, ny + PANELS_SPACING, w, h - 13 - PANELS_SPACING, PANELS_SPACING);
